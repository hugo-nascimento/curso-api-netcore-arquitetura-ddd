...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                Environment.SetEnvironmentVariable("DB_CONNECTION", "Server=.\\SQLEXPRESS;Initial Catalog=dbApi_Integration;MultipleActiveResultSets=true;User ID=sa;Password=castle123");
